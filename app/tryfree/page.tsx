            ...
            <div className="min-h-screen flex flex-col lg:flex-row">
                ...
                <div className="flex-1 px-6 md:px-12 lg:px-16 py-8 md:py-12 lg:py-16 flex flex-col justify-center">
                    ...
                    <div className="text-center lg:text-left mb-8 md:mb-12">
                        <h1 className="font-bold text-[#162694] text-2xl md:text-3xl lg:text-[35px] mb-4 font-['Geist']">
                            InteliDoc
                        </h1>
                        <h2 className="font-normal text-black text-lg md:text-xl lg:text-[25px] font-['Playfair_Display'] leading-relaxed">
                    ...
                    {/* Marketing text */}
                    <div className="text-center lg:text-left mb-8 md:mb-12">
                        <p className="font-medium text-lg md:text-xl lg:text-[25px] font-['Playfair_Display'] leading-relaxed">
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="flex justify-center lg:justify-start">
                                <img
                                    ...
                                    alt="5 stars rating"
                                    src="/noun-5-stars-rating-2423370-3.svg"
                                />
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <Card className="bg-[#f4f0f0] shadow-lg border-none">
                            <CardContent className="p-6 md:p-8">
                                ...
                                <div className="text-center mb-6 md:mb-8">
                                    <h3 className="font-medium text-black text-xl md:text-2xl lg:text-[25px] font-['Playfair_Display'] leading-tight mb-4">
