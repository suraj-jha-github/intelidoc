  ...
  return (
    <div className="bg-[#f3f3f3] flex flex-row justify-center w-full">
      <div className="bg-[#f3f3f3] overflow-hidden w-full relative">
        {/* Navigation Bar */}
        <nav className="fixed top-0 left-0 right-0 w-full h-14 sm:h-[57px] backdrop-blur-[21px] bg-gradient-to-b from-white/60 to-transparent z-50">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 flex items-center justify-between h-full">
            <div className="flex items-center">
              <h1 className="font-['Geist',Helvetica] font-bold text-white text-lg sm:text-xl mr-4 sm:mr-12">
                InteliDoc AI
              </h1>

              <ul className="hidden lg:flex space-x-4 xl:space-x-6">
                <li className="font-['Gantari',Helvetica] font-medium text-white text-sm xl:text-[15px] hover:text-gray-200 cursor-pointer">
                  Features
                </li>
                <li className="font-['Gantari',Helvetica] font-medium text-white text-sm xl:text-[15px] hover:text-gray-200 cursor-pointer">
                  How it Works
            ...
            <Button className="bg-white text-[#162694] h-6 sm:h-7 rounded-[5px] px-2 sm:px-3 text-sm hover:bg-gray-100 transition-colors">
              <span className="font-['Gantari',Helvetica] font-semibold text-xs sm:text-[15px]">
                Try for free
              </span>
            </Button>
          </div>
        ...
        {/* Security Section */}
        <section className="relative w-full py-6 sm:py-8 border-t border-gray-300 mt-8">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
            <h2 className="font-['Playfair_Display',Helvetica] font-semibold text-[#162694] text-2xl sm:text-3xl text-center lg:text-left">
              Security & Legal
            </h2>
            <p className="font-['Gantari',Helvetica] font-normal text-[#626262] text-lg sm:text-xl mt-4 max-w-[1004px] text-center lg:text-left">
