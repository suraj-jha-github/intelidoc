...
export const CTASection: React.FC = () => {
  ...
  return (
    <section className="w-full min-h-[300px] bg-[#f3f3f3] flex flex-col items-center justify-center py-6 md:py-0 pl-4 sm:pl-8 md:pl-16 lg:pl-[85px] pr-4 sm:pr-8 md:pr-16 lg:pr-[85px] pt-0">
      <h2 className="font-semibold text-[#162694] text-2xl md:text-3xl lg:text-5xl mb-8 md:mb-12 text-center">
